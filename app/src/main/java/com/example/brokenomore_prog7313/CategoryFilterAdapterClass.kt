...
class CategoryFilterAdapterClass (
    private val dataList:ArrayList<CategoryFilterData>
) : RecyclerView.Adapter<CategoryFilterAdapterClass.ViewHolderClass>(){
    ...
    override fun onBindViewHolder(holder: ViewHolderClass, position: Int) {
        ...
        val bitmap = decodeBase64ToBitmap(currentItems.categoryIcon)
        if (bitmap != null) {
        ...
        holder.rvAmount.text = "R %.2f".format(currentItems.amount)
    }
